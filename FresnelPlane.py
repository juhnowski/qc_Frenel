#!/usr/bin/env python
"""
Дифракция Френеля на плоском фронте и круглом отверстии
"""
import matplotlib
...
root.wm_title("Дифракция Френеля на плоском фронте и круглом отверстии.        LP-version = " + LPversion)
...
def TheExample(event):
    ...
    str='Распределение интенсивности\nцентральная освещенность = %3.3f [a.u.]' %I[N2][N2]
    ax1.set_title(str) 
    canvas.draw()
...
def openbrowser(event):
    webbrowser.open_new(r"https://github.com/juhnowski/qc_Frenel")
